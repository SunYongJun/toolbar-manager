        ...
        <div id="usual1" class="usual">
            ...
            <div id="tab1" class="tabson">
                ...
                <li>
                    ...
                    <input name="title" value="{{ group.title }}" type="text" class="dfinput"  style="width:518px;" required/>
                ...
                <li>
                    ...
                    <div style="float:left;width:750px;">
                        {% for rule in rules %}
                            <div class="checkdiv">
                                <input type="checkbox" class="uniform_on" name="ids[]" value="{{ rule.id }}" {% if rule.id in rulesIds %} checked {% endif %} /> {{ rule.title }}
                            </div>                            
                        {% endfor %}
                    </div>                    
                </li>
